    ...
    <header class="apple-global-nav">
      <div class="global-nav-inner">
        ...
        <nav class="global-nav-links">
          <RouterLink to="/" class="g-nav-link">산단 대시보드</RouterLink>
          <RouterLink to="/radar" class="g-nav-link">전국 레이더</RouterLink>
          <RouterLink to="/alerts" class="g-nav-link">
            안전 수칙
            <span v-if="alertStore.dangerCount > 0" class="nav-danger-dot">
              {{ alertStore.dangerCount }}
            </span>
          </RouterLink>
          <RouterLink to="/archive" class="g-nav-link">기술 아카이브</RouterLink>
          <RouterLink to="/practices" class="g-nav-link">교재 실습장</RouterLink>
          <RouterLink to="/about" class="g-nav-link">서비스 소개</RouterLink>
        </nav>
    ...
    <footer class="apple-footer">
      <div class="footer-inner">
        ...
        <div class="footer-disclaimer-box">
          <p>
            * 본 기상 관제 시스템은 OpenWeatherMap REST API(Current, 5-Day Forecast, Air Pollution, Weather Radar Tile)를 통해 대한민국 6대 국가산업단지(울산, 여수, 포항, 창원, 구미, 대산)의 기상 수치를 30초 주기로 실시간 분석합니다. 공정별 물리 파손 모델(기온·습도·기압 상관 수식)을 통해 설비 위험 지표를 사전 산출하며, 위급 상황 발생 시 자동으로 다크 관제 테마로 전환됩니다.
          </p>
        </div>
        ...
        <div class="footer-nav-grid">
          <div class="footer-nav-col">
            ...
            <ul class="footer-links-list">
              <li><RouterLink to="/" class="footer-link">산단 대시보드</RouterLink></li>
          ...
          <div class="footer-nav-col">
            ...
            <ul class="footer-links-list">
              ...
              <li><RouterLink to="/practices" class="footer-link">1~15단원 교재 실습장</RouterLink></li>
              <li><RouterLink to="/about" class="footer-link">재해 물리 메커니즘</RouterLink></li>
              <li><a href="https://openweathermap.org/api" target="_blank" rel="noreferrer" class="footer-link">OpenWeatherMap API ↗</a></li>
            </ul>
          </div>
