    ...
    <el-tabs v-model="activeTab" type="border-card" class="custom-el-tabs">
      ...
      <el-tab-pane label="🛠️ 트러블슈팅 5대 난제" name="troubleshoot">
        ...
        <div class="trouble-list">
          <div v-for="(t, idx) in troubleList" :key="idx" class="trouble-card">
      ...
      <el-tab-pane label="🏭 6대 산단 물리 모델" name="domain">
        ...
        <div class="domain-list">
          <div v-for="(d, idx) in domainList" :key="idx" class="domain-card">
      ...
      <el-tab-pane label="🏛️ 아키텍처 결정 (ADR)" name="architecture">
        ...
        <div class="adr-list">
          <div v-for="adr in adrList" :key="adr.id" class="adr-card">
...
.pane-header {
  margin-bottom: 20px;
  padding-bottom: 14px;
  border-bottom: 1px solid var(--colors-hairline, #d2d2d7);
}
...
.showcase-card {
  ...
  border-radius: var(--rounded-md, 14px);
  padding: 18px 22px;
}
