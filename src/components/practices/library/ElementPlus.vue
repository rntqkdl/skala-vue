...
<template>
  <div class="practice-section">
    <h2>Element Plus 활용 실습 (교재 233p~248p)</h2>
    <p class="subtitle">외부 API와 무관하게 템플릿과 상태값 변동만을 관측하는 샘플입니다.</p>

    <el-card class="box-card">
      <template #header><strong>📝 실습 1. 회원가입 Form 및 인풋 제어</strong></template>
      <div class="card-body">
    ...
    <el-card class="box-card">
      <template #header><strong>⚙️ 실습 3. 시스템 피드백 및 프로그레스 인터랙션</strong></template>
      <div class="card-body">
        <div class="btn-zone">
